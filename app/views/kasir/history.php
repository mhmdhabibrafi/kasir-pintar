                ...
                <?php if (!empty($row['meta'])): ?>
                    ...
                    <div class="kp-muted small">
                        ...
                        <?php if (!empty($meta['order_discount']['amount'])): ?>
                            &middot; Order: <?php echo e(format_rupiah((float) ($meta['order_discount']['amount'] ?? 0))); ?>
                        <?php endif; ?>
                        <?php if (!empty($meta['voucher']['amount'])): ?>
                            &middot; Voucher: <?php echo e(format_rupiah((float) ($meta['voucher']['amount'] ?? 0))); ?>
                        <?php endif; ?>
                    </div>
                    <div class="kp-muted small">
                        Pajak: <?php echo e(format_rupiah((float) ($meta['tax']['amount'] ?? 0))); ?>
                        &middot; Service: <?php echo e(format_rupiah((float) ($meta['service']['amount'] ?? 0))); ?>
                        &middot; Pembulatan: <?php echo e(format_rupiah((float) ($meta['rounding']['amount'] ?? 0))); ?>
                    </div>
                    <?php if (!empty($meta['customer']['name'])): ?>
                        <div class="kp-muted small">
                            Member: <?php echo e((string) ($meta['customer']['name'] ?? '-')); ?>
                            <?php if (!empty($meta['customer']['points_earned'])): ?>
                                &middot; Poin +<?php echo e((string) ((int) ($meta['customer']['points_earned'] ?? 0))); ?>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
                <?php endif; ?>
