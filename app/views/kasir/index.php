...
<?php if (!empty($success)): ?>
    <div class="alert alert-success">
        ...
        <?php if (!empty($lastTransactionId)): ?>
            <div class="mt-2">
                <a class="btn btn-sm btn-light" target="_blank" href="<?php echo e(base_url('print_receipt.php?id=' . (int) $lastTransactionId)); ?>">
    ...
    <div class="kp-card-flat p-3 mb-3">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
            <div>
                ...
                <div class="kp-muted small">ID: <?php echo e($shiftInfo['shift_id'] ?? '-'); ?> · Mulai: <?php echo e($shiftInfo['opened_at'] ?? '-'); ?></div>
            </div>
...
<div class="kp-card-flat p-3 mb-3">
    <div class="input-group">
        ...
        <input type="text" id="productSearch" class="form-control border-0" placeholder="Cari produk favorit...">
    </div>
</div>
...
<script>
    ...
    const renderCartList = (targetEl) => {
        ...
        Object.keys(cartState).forEach((productId) => {
            ...
            const productName = document.querySelector('#qty-view-' + productId).closest('.kp-product-card').querySelector('.fw-semibold').textContent;
        ...
        heldCarts.forEach((hold) => {
            ...
            row.innerHTML = `
                <div>
                    ...
                    <div class="kp-muted small">${hold.created_at}</div>
                </div>
                <div class="d-flex gap-2">
