...
class BosReportPDF extends BasePDF
{
    ...
    function Header(): void
    {
        ...
        $this->Cell(0, 6, pdf_text('KASIR PINTAR'), 0, 1, 'C');
    ...
    function Footer(): void
    {
        ...
        $this->Cell(0, 4, pdf_text('KASIR PINTAR | Halaman ' . $this->PageNo() . '/{nb}'), 0, 0, 'C');
...
function build_receipt_pdf(array $receipt): string
{
    ...
    $pdf->Cell(0, 4, pdf_text('KASIR PINTAR'), 0, 1, 'C');
    ...
    $pdf->Cell(0, 4, pdf_text($divider), 0, 1, 'C');
    $pdf->SetFont('Courier', '', 8);
    $pdf->Cell(0, 4, pdf_text('@kasirpintar'), 0, 1, 'C');
