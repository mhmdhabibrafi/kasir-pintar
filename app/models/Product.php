...
class Product
{
    public static function all(PDO $pdo): array
    {
        ...
        if ($categoryColumn) {
            $stmt = $pdo->query(
                'SELECT products.id, products.name, products.price' . $selectCost . $selectStock . ',
        ...
        $stmt = $pdo->query('SELECT products.id, products.name, products.price' . $selectCost . $selectStock . ' FROM products ' . $whereActive . ' ORDER BY products.name');
        return $stmt->fetchAll();
    }
